  ...
  return (
    <section class="text-gray-600 h-[350px] flex justify-center items-center shadow-md   w-3/4 mx-auto my-20 body-font">
        ...
        <div className='w-1/2 flex justify-center items-center h-full'>
            <img className="w-3/4 m-2 bg-slate-700 rounded-lg" src={`${background}`} alt=''></img>
        </div>
        <div className='w-1/2 h-full'>
            <h1 class="md:text-3xl mt-9 text-2xl font-medium title-font text-gray-900">
                Reach Our Offline Centers
            </h1>
            <h3 class="md:text-lg text-md mt-2 title-font text-gray-600">
                Available In Noida, New Delhi
            </h3>
            <ul className='list-inside text-lg list-none font-medium leading-8 my-8 text-emerald-600'>
