      ...
      <div class="container py-24 mx-auto">
        <div class="flex flex-col w-full md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
          <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">
            CHEMISTRY IS THE PIECE OF CAKE
          </h2><h1 class="md:text-3xl text-2xl font-medium title-font text-gray-900">
        ...
        <div class="mt-12 flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4">
        ...
        <div className="bg-slate-600 w-1/3 my-6">Hello</div>
      </div>
    </section>
  );
}
