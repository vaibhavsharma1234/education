...
function Footer() {
  return (
    <>
    <footer className="px-4 mt-12 divide-y bg-gray-100 text-gray-800">
	...
	<div className="py-6 text-sm text-center text-gray-600">© {new Date().getFullYear()} | All rights reserved.</div>
</footer>
    </>
  )
}
