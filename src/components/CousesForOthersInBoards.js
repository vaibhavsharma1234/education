...
function CousesForOthersInBoards(props) {
  ...
  return (
    <>
<section>
<div class="container px-6 mx-auto  bg-gradient-to-r from-red-500 to-rose-400 subpixel-antialiased">
  ...
  <div class="px-6 py-12 md:px-12 text-center lg:text-left">
    <div class="container mx-auto">
      ...
      <section class="text-gray-600 py-8 flex justify-center items-center shadow-md   w-3/4 mx-auto my-20 body-font">
        ...
        <div className="w-3/5 h-full">
          <h1 class="md:text-3xl mt-9 text-2xl font-medium title-font text-gray-900">
            <i class="fa-sharp fa-solid fa-flask text-rose-600 mr-2"></i>Chemistry
          </h1>
          ...
          <div className="w-3/4 flex  mt-8">
            <div className="border-r-2 border-gray-400 h-full w-1/3 flex flex-col justify-center items-center">
              <div>
                <i class="fa-solid fa-vial text-3xl text-rose-600"></i>
              </div>
            ...
            <div className=" h-full w-1/3 border-r-2 border-gray-400 flex flex-col justify-center items-center">
              <div>
                <i class="fa-solid fa-flask-vial text-3xl text-rose-600"></i>
              </div>
              <div className="mt-1">Matter</div>
            </div>
            <div className="h-full w-1/3 flex flex-col justify-center items-center">
              <div>
                <i class="fa-solid fa-atom text-3xl text-rose-600"></i>
              </div>
          ...
          <div className="relative w-full flex justify-end pr-16">
            <button
              class="text-white relative  mt-12  bg-rose-600 border-0 py-2 px-3 focus:outline-none hover:bg-rose-700 rounded text-md"
              onMouseOver={(e)=>{
                e.preventDefault();
                setShowDropdown1(1);
              }}
      ...
      <section class="text-gray-600 py-8 flex justify-center items-center shadow-md   w-3/4 mx-auto my-20 body-font">
        ...
        <div className="w-3/5 h-full">
          <h1 class="md:text-3xl mt-9 text-2xl font-medium title-font text-gray-900">
            <i class="fa-solid fa-temperature-low text-rose-600 mr-2"></i>Physics
          </h1>
          <h3 class="text-md mt-2 title-font text-gray-500">
          ...
          <div className="w-3/4 flex  mt-8">
            <div className="border-r-2 border-gray-400 h-full w-1/3 flex flex-col justify-center items-center">
              <div>
                <i class="fa-brands fa-space-awesome text-3xl text-rose-600"></i>
              </div>
              <div className="mt-1">Proofs</div>
            </div>
            <div className=" h-full w-1/3 border-r-2 border-gray-400 flex flex-col justify-center items-center">
              <div>
                <i class="fa-solid  fa-user-astronaut text-3xl text-rose-600"></i>
              </div>
              <div className="mt-1">Patterns</div>
            </div>
            <div className="h-full w-1/3 flex flex-col justify-center items-center">
              <div>
                <i class="fa-solid fa-fire-flame-simple text-3xl text-rose-600"></i>
              </div>
      ...
      <section class="text-gray-600 py-8 flex justify-center items-center shadow-md   w-3/4 mx-auto my-20 body-font">
        ...
        <div className="w-3/5 h-full">
          <h1 class="md:text-3xl mt-9 text-2xl font-medium title-font text-gray-900">
            <i class="fa-solid fa-not-equal text-rose-600 mr-2"></i>Mathematics
          </h1>
          <h3 class="text-md mt-2 title-font text-gray-500">
          ...
          <div className="w-3/4 flex  mt-8">
            <div className="border-r-2 border-gray-400 h-full w-1/3 flex flex-col justify-center items-center">
              <div>
                <i class="fa-solid fa-calculator text-3xl text-rose-600"></i>
              </div>
              <div className="mt-1">Precision</div>
            </div>
            <div className=" h-full w-1/3 border-r-2 border-gray-400 flex flex-col justify-center items-center">
              <div>
                <i class="fa-solid  fa-square-root-variable text-3xl text-rose-600"></i>
              </div>
              <div className="mt-1">Computation</div>
            </div>
            <div className="h-full w-1/3 flex flex-col justify-center items-center">
              <div>
                <i class="fa-solid fa-infinity text-3xl text-rose-600"></i>
              </div>
      ...
      <section class="text-gray-600 py-8 flex justify-center items-center shadow-md   w-3/4 mx-auto my-20 body-font">
        ...
        <div className="w-3/5 h-full">
          <h1 class="md:text-3xl mt-9 text-2xl font-medium title-font text-gray-900">
            <i class="fa-solid fa-temperature-low text-rose-600 mr-2"></i>Biology
          </h1>
          <h3 class="text-md mt-2 title-font text-gray-500">
          ...
          <div className="w-3/4 flex  mt-8">
            <div className="border-r-2 border-gray-400 h-full w-1/3 flex flex-col justify-center items-center">
              <div>
                <i class="fa-solid fa-dna text-3xl text-rose-600"></i>
              </div>
              <div className="mt-1">Research</div>
            </div>
            <div className=" h-full w-1/3 border-r-2 border-gray-400 flex flex-col justify-center items-center">
              <div>
                <i class="fa-solid  fa-tablets text-3xl text-rose-600"></i>
              </div>
              <div className="mt-1">Observation</div>
            </div>
            <div className="h-full w-1/3 flex flex-col justify-center items-center">
              <div>
                <i class="fa-solid fa-radiation text-3xl text-rose-600"></i>
              </div>
